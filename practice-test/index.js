...
// 3.
var filterSpecies = dogs.filter(function(val){
...
// dogs.filter(function(entry){
//     if(entry.species === "dog"){
//         filterSpecies.push(entry);
//     }
...
// 6.
var firstInClass = function(dogsWithClasses){
    //base case
    if(dogsWithClasses.length === 0){
        return {};
    }
    //recursive call;
    return Object.assign({}, dogsWithClasses[0], firstInClass(dogsWithClasses.slice(1)))
};
